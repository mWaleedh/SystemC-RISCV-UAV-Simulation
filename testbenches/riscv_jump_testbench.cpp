...
addi x1, x0, 5        x1 = 5
jal  x5, +8           Skips next instruction

addi x2, x0, 99       Skipped

addi x2, x0, 10       x2 = 10 (Jump target)
add  x3, x1, x2       x3 = 15
...
jalr x6, 0(x1)        Skip next instruction

addi x4, x0, 99       Skipped

addi x4, x0, 7        Jump target
*/
...
int sc_main(int argc, char* argv[]) {
    ...
    sc_trace(wf, sys.cpu->id_ex.imm, "jump_immediate");
    sc_trace(wf, sys.cpu->ex_mem.alu_res, "return_address");
