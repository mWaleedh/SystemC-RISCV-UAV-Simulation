...
int sc_main(int argc, char* argv[]) {
    ...
    sc_trace(wf, sys.cpu->data_addr_bus_o, "cpu_addr");
    sc_trace(wf, sys.cpu->data_read_en_o, "read_en");
    sc_trace(wf, sys.cpu->data_write_en_o, "write_en");
    ...
    if (sys.irq_timer_s.read() == true) {
        cout << "PASS: Timer Interrupt Triggered" << endl << endl;
    }
    else {
