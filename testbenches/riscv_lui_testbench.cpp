...
Program loads GPIO address into x1 and uses it to write 99 to its output 
*/
...
int sc_main(int argc, char* argv[]) {
    ...
    sc_trace(wf, sys.cpu->data_addr_bus_o, "addr_bus");
    ...
    cout << "gpio.output_reg = 99: " << (sys.tlm_gpio->output_reg == 99 ? "PASS" : "FAIL") << endl;
