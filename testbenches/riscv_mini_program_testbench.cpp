...
int sc_main(int argc, char* argv[]) {
    ...
    sc_trace(wf, sys.cpu->id_ex.rd, "rd");
    sc_trace(wf, sys.cpu->id_ex.rs1, "rs1");
    sc_trace(wf, sys.cpu->id_ex.rs2, "rs2");
    sc_trace(wf, sys.cpu->id_ex.imm, "immediate");
    sc_trace(wf, sys.cpu->ex_mem.alu_res, "alu_rest");
    sc_trace(wf, sys.mem->data_bus_i, "mem_data_in");
    sc_trace(wf, sys.mem->data_bus_o, "mem_data_out");
    sc_trace(wf, sys.mem->data_read_en_i, "read_en");
    sc_trace(wf, sys.mem->data_write_en_i, "write_en");
    ...
    cout << "mem[20] = 100: " << (sys.tlm_mem->memory[20] == 100 ? "PASS" : "FAIL") << endl << endl;
