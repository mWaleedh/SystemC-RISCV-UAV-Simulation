...
all: memory_test decode_test load_store_test branch_test jump_test mini_program_test
...
clean:
	rm -f memory_test decode_test load_store_test branch_test jump_test mini_program_test *.vcd