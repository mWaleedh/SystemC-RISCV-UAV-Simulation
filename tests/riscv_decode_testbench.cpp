...
int sc_main(int argc, char* argv[]) {
    ...
    // VCD waveform trace
    sc_trace_file *wf = sc_create_vcd_trace_file("./tests/waveform/riscv_decode_waveform");
    ...
    sys.load_data(0, 0x00500093);
    sys.load_data(4, 0x00A00113);
    sys.load_data(8, 0x002081B3);
